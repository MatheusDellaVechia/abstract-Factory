...
export class MortgageLoan extends Loan  {
        ...
        constructor(loanId: string, amount: number, income: number, installments: number) {
            ...
            if (installments > 420) throw new Error("The maximum number of installment for mortgage loan is 420");
            if ((income * 0.25) < amount/installments) throw new Error("The installment amount cold not exced 25% of monthly income");
        }
...
export class CarLoan extends Loan {
    ...
    constructor(loanId: string, amount: number, income: number, installments: number) {
        super(loanId, amount, income, installments, "mortgage");
        if (installments > 60) throw new Error("The maximum number of installment for car loan is 60");
        if ((income * 0.30) < amount/installments) throw new Error("The installment amount cold not exced 30% of monthly income");
    }
